...
/**
 * TODO: Description of {@code DespachoServiceImpl}.
 *
 * @author Dyson Parra
...
public class DespachoServiceImpl implements GenericService<DespachoDTO> {
    ...
    public Page<DespachoDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Despacho con paginación");
    ...
    public DespachoDTO saveUpdate(DespachoDTO entityDTO) throws Exception {
        ...
        DespachoDTO dto = entityMapping.getDto(entity);
        return dto;
    }
