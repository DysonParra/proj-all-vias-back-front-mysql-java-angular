/*
 * @overview        {CodigoIdentificacionVialServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code CodigoIdentificacionVialServiceImpl}.
 *
 * @author Dyson Parra
...
public class CodigoIdentificacionVialServiceImpl implements GenericService<CodigoIdentificacionVialDTO> {
    ...
    public Page<CodigoIdentificacionVialDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo CodigoIdentificacionVial con paginación");
    ...
    public CodigoIdentificacionVialDTO saveUpdate(CodigoIdentificacionVialDTO entityDTO) throws Exception {
        ...
        CodigoIdentificacionVialDTO dto = entityMapping.getDto(entity);
        return dto;
    }
