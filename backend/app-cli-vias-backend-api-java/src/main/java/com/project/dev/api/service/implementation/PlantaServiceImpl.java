...
/**
 * TODO: Description of {@code PlantaServiceImpl}.
 *
 * @author Dyson Parra
...
public class PlantaServiceImpl implements GenericService<PlantaDTO> {
    ...
    public Page<PlantaDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Planta con paginación");
    ...
    public PlantaDTO saveUpdate(PlantaDTO entityDTO) throws Exception {
        ...
        PlantaDTO dto = entityMapping.getDto(entity);
        return dto;
    }
