...
/**
 * TODO: Description of {@code OrigenServiceImpl}.
 *
 * @author Dyson Parra
...
public class OrigenServiceImpl implements GenericService<OrigenDTO> {
    ...
    private final OrigenMapping entityMapping = Mappers.getMapper(OrigenMapping.class);
     ...
     */
    public OrigenServiceImpl(OrigenRepository entityRepository) {
    ...
    public Page<OrigenDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Origen con paginación");
     ...
     */
    @Override
    public OrigenDTO saveUpdate(OrigenDTO entityDTO) throws Exception {
        log.debug("Solicitud para guardar la entidad tipo Origen: {}", entityDTO);

        //TODO: agregar validación específica del servicio.
        Origen entity = entityMapping.getEntity(entityDTO);
        entity = entityRepository.save(entity);

        OrigenDTO dto = entityMapping.getDto(entity);
        return dto;
    }
     ...
     */
    @Override
    public OrigenDTO getEntity(String id) throws Exception {
    ...
    public void deleteEntity(String id) throws Exception {
        log.debug("Solicitud para eliminar la entidad tipo Origen: {}", id);
