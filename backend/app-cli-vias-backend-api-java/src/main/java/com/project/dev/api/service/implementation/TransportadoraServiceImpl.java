/*
 * @overview        {TransportadoraServiceImpl}
 *
 * @version         2.0
 *
...
/**
 * TODO: Description of {@code TransportadoraServiceImpl}.
 *
 * @author Dyson Parra
...
public class TransportadoraServiceImpl implements GenericService<TransportadoraDTO> {
    ...
    public Page<TransportadoraDTO> getAllEntitiesPaged(Pageable pageable) throws Exception {
        log.debug("Solicitud para listar todas las Entidades tipo Transportadora con paginación");
    ...
    public TransportadoraDTO saveUpdate(TransportadoraDTO entityDTO) throws Exception {
        ...
        TransportadoraDTO dto = entityMapping.getDto(entity);
        return dto;
    }
