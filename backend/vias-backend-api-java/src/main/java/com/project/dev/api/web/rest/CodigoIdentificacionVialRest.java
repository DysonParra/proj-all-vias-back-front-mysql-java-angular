/*
 * @fileoverview    {CodigoIdentificacionVialRest} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class CodigoIdentificacionVialRest {
    ...
    public ResponseEntity<List<CodigoIdentificacionVialDTO>> getAllEntitiesPaged(Pageable pageable) {
