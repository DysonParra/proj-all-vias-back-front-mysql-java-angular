/*
 * @fileoverview    {CodigoIdentificacionVialServiceImpl} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
public class CodigoIdentificacionVialServiceImpl implements CodigoIdentificacionVialService {
    ...
    public CodigoIdentificacionVialDTO saveUpdate(CodigoIdentificacionVialDTO entityDTO) throws Exception {
        ...
        CodigoIdentificacionVialDTO actualEntity = entityMapping.obtenerDto(entity);
        return actualEntity;
    }
