...
public class PlantaRest {
    ...
    public ResponseEntity<List<PlantaDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<PlantaDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
