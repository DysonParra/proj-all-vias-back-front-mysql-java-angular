/*
 * @fileoverview    {IngresoRepository} se encarga de realizar tareas específicas.
 *
 * @version         2.0
 *
...
/**
 * TODO: Definición de {@code IngresoRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface IngresoRepository extends JpaRepository<Ingreso, Integer> {
     ...
     */
    public List<Ingreso> findByIntNoTiquete(Integer id);
    ...
    @Query("SELECT m FROM Ingreso m WHERE m.intNoTiquete LIKE CONCAT('%', :strSearch, '%')")
    public List<Ingreso> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Ingreso m WHERE m.intNoTiquete LIKE CONCAT('%', :strSearch, '%')")
    public Page<Ingreso> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
