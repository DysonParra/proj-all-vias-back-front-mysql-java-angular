...
public class DespachoRest {
    ...
    public ResponseEntity<List<DespachoDTO>> getAllEntitiesPaged(Pageable pageable) {
    ...
    public ResponseEntity<List<DespachoDTO>> searchEntitiesPaged(@PathVariable String query, Pageable pageable) {
