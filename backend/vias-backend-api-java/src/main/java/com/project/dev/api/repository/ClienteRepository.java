...
/**
 * TODO: Definición de {@code ClienteRepository}.
 *
 * @author Dyson Parra
 * @since 1.8
 */
...
public interface ClienteRepository extends JpaRepository<Cliente, String> {
     ...
     */
    public List<Cliente> findByStrNit(String id);
    ...
    @Query("SELECT m FROM Cliente m WHERE m.strNit LIKE CONCAT('%', :strSearch, '%')")
    public List<Cliente> searchEntities(@Param("strSearch") String strSearch);
    ...
    // TODO: Especificar campo de la entidad donde realizar la búsqueda.
    @Query("SELECT m FROM Cliente m WHERE m.strNit LIKE CONCAT('%', :strSearch, '%')")
    public Page<Cliente> searchEntities(@Param("strSearch") String strSearch, Pageable pageable);
}
