...
/**
 * TODO: Description of {@code PlantaViewModel}.
 *
 * @author Dyson Parra
...
export class PlantaViewModel extends GenericViewModel<number> {
     ...
     *
     */
    public newEntity(): PlantaViewModel {
        return new PlantaViewModel();
    }
