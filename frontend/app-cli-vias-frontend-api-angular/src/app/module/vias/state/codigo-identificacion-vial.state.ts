...
/**
 * TODO: Description of {@code CodigoIdentificacionVialState}.
 *
 * @author Dyson Parra
...
export class CodigoIdentificacionVialState extends GenericState<CodigoIdentificacionVialViewModel> {
